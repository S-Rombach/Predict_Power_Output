...
OPENMETEO_WEATHER_FILENAME = "openmeteo_weather_data.csv"
""" Name of the file with weather data from Open-Meteo. """
POWER_DWD_WEATHER_FILENAME = "power_dwd_weather_data.csv"
""" Name of the file with combined power data enriched with weather data from DWD. """
POWER_OPENMETEO_WEATHER_FILENAME = "power_openmeteo_weather_data.csv"
""" Name of the file with combined power data enriched with weather data from Open-Meteo. """
